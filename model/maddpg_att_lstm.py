...
from agent.agent_att_lstm import Agent
...
class MADDPGWithAttentionLSTM:
    ...
    def __init__(self, actor_dims, critic_dims, n_agents, n_actions,
                 ...
                 fc2=128, gamma=0.99, tau=0.01, chkpt_dir='tmp/maddpgwithatt/', act_dim = 2, obs_agt = 26, obs_tar = 23, lstm_hidden_dim = 256):
        ...
        for agent_idx in range(self.n_agents):
            self.agents.append(Agent(actor_dims[agent_idx], critic_dims,
                            ...
                            chkpt_dir=chkpt_dir, dim_info=dim_info, agent_id=agent_idx, lstm_hidden_dim = lstm_hidden_dim))
    ...
    def learn(self, memory, total_steps, current_state):
        ...
        actor_states, states, actions, rewards, \
            actor_new_states, states_, dones, hidden_states, next_hidden_states = memory.sample_buffer()
        #     # [256,] [256,]
