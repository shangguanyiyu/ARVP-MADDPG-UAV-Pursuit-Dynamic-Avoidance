...
class CriticNetwork_1(nn.Module):
    ...
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims,
                 n_agents, n_actions, name, chkpt_dir, dim_info, agent_id, hidden_dim, lstm_hidden_dim, is_recurrent=True):
        ...
        # q_value 输出
        if self.recurrent:
            self.lstm = T.nn.LSTM(hidden_dim, lstm_hidden_dim, batch_first=True, num_layers=4)
...
class CriticNetwork_2(nn.Module):
    ...
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims,
        ...
        if self.recurrent:
            self.lstm = nn.LSTM(hidden_dim, lstm_hidden_dim, batch_first=True, num_layers=4)
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims,
                 n_actions, name, chkpt_dir,lstm_hidden_dim, is_recurrent = True):
        ...
        if self.is_recurrent:
            # print("yes")
            self.lstm = nn.LSTM(input_dims, lstm_hidden_dim, batch_first=True, num_layers=4)
