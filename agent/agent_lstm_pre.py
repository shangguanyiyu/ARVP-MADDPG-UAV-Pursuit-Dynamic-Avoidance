import torch as T
from model.networks_lstm_pre import ActorNetwork, CriticNetwork
import numpy as np
...
class Agent:
    def __init__(self, actor_dims, critic_dims, n_actions, n_agents, agent_idx, chkpt_dir,
        ...
        self.critic = CriticNetwork(beta, critic_dims,
                            ...
                            chkpt_dir=chkpt_dir, name=self.agent_name+'_critic', lstm_hidden_dim=lstm_hidden_dim, num_layers=num_layers)
        ...
        self.target_critic = CriticNetwork(beta, critic_dims,
                                            fc1, fc2, n_agents, n_actions,
                                            chkpt_dir=chkpt_dir,
                                            name=self.agent_name+'_target_critic', lstm_hidden_dim=lstm_hidden_dim, num_layers=num_layers)
