import torch as T
from model.networks_att_2 import ActorNetwork, CriticNetwork_1, CriticNetwork_2
import numpy as np
...
class Agent:
    def __init__(self, actor_dims, critic_dims, n_actions, n_agents, agent_idx, chkpt_dir, dim_info, agent_id,
        ...
        self.critic = CriticNetwork_1(beta, critic_dims,
                            ...
                            chkpt_dir=chkpt_dir, name=self.agent_name+'_critic', dim_info=dim_info, agent_id=agent_id, hidden_dim=128)
        ...
        self.target_critic = CriticNetwork_2(beta, critic_dims,
                                            fc1, fc2, n_agents, n_actions,
                                            chkpt_dir=chkpt_dir,
                                            name=self.agent_name+'_target_critic', dim_info=dim_info, agent_id=agent_id, hidden_dim=128)

        self.update_network_parameters(tau=1) #0.005
