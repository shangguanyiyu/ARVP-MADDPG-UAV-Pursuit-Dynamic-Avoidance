...
from env.sim_env_vo import UAVEnv
...
def create_unique_log_dir(base_dir="runs/UAV_training_VO"):
    idx = 1
    while True:
        log_dir = f"{base_dir}{idx:02d}"  # 例如 UAV_training_VO01, UAV_training_VO02
...
if __name__ == '__main__':
    ...
    csv_train_file = os.path.join(csv_log_dir, "train_log_vo_5000.csv")
    ...
    # 3D + VO 立体锥 observation dims: hunter=65, target=59 (derived from env.observation_space)
    ...
    beta = 0.001 # 0.001
    chkpt_dir = 'tmp_avoid_dynamic/maddpg_vo/'
